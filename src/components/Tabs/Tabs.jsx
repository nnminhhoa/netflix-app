...
const Tabs = ({ activeTabName, onClickTab }) => {
  const { CANCER_AT_ANY_TIME, WATCH_ANYwHERE, PICK_YOUR_PRICE } = tabLabels;
    ...
    <>
      <section className="tabs">
        <div className="container">
          {renderTabTitle(
            CANCER_AT_ANY_TIME,
            activeTabName === CANCER_AT_ANY_TIME,
          ...
          <div className="container">
            <div
              ...
              className={`tab-content-item ${
                activeTabName === CANCER_AT_ANY_TIME && "show"
              }`}
            >
              <div className="tab-1-content-inner">
                ...
                <img src="http://i.ibb.co/J2xDJV7/tab-content-1.png" alt="" />
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            ...
            >
              ...
              <div className="tab-2-content-bottom">
                <div>
                  <img
                    src="http://i.ibb.co/DpdN7Gn/tab-content-2-1.png"
                    alt=""
                  />
                  <p className="text-md">Watch on your TV</p>
                  <p className="text-dark">
                    Smart TVs, PlayStation, Xbox, Chormecast, Apple TV, Blu-ray
                    players and more.
                  </p>
                </div>
                <div>
                  <img
                    src="http://i.ibb.co/R3r1SPX/tab-content-2-2.png"
                    alt=""
                  />
                  <p className="text-md">
                ...
                <div>
                  <img
                    src="http://i.ibb.co/gDhnwWn/tab-content-2-3.png"
                    alt=""
                  />
          ...
          <div className="container">
            ...
            >
              ...
              <table className="table">
                ...
                <tbody>
                  <tr>
                    <td>Monthly price after free month ends on 06/09/2021</td>
                    <td>$6.99</td>
                    <td>$11.99</td>
                    <td>$15.99</td>
                  </tr>
